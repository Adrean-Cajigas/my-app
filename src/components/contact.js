...
export default function Contact() {
    ...
    return (
        <section className="px-[6rem] py-[8rem] rounded-[6rem] container mx-auto ">
            ...
            <form onSubmit={handleSubmit} className="text-center font-medium text-[1.5rem] w-[80%] mx-auto mb-[4rem]">
                <p className='leading-[4rem] mb-[4rem]'>
                ...
                <button type="submit" className="bg-primary px-[2.5rem] py-[.6rem] rounded-[2rem] text-background font-semibold text-[1.2rem]
