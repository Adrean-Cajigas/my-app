...
export default function Footer() {
    ...
    return(
        <footer className="bg-primary rounded-t-[2rem] px-[7rem] py-[4rem] tablet-s:px-[2rem] tablet-s:py-[3rem] text-background">
            <div className="container mx-auto flex justify-between items-center mobile:flex-col">
                ...
                <div className="flex flex-col items-end pt-[1.5rem] mobile:flex-row mobile:justify-center mobile:items-center mobile:gap-10">
